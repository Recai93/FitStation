 ...
 */
public class AddTrainerActivity extends BaseActivity {
    private EditText mEditTextAddFriendEmail;
    private AutocompleteTrainerAdapter mFriendsAutocompleteAdapter;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mEditTextAddFriendEmail.addTextChangedListener(new TextWatcher() {
            ...
            /* Define and set the adapter otherwise. */
                    ...
                    mFriendsAutocompleteAdapter = new AutocompleteTrainerAdapter(AddTrainerActivity.this, User.class,
