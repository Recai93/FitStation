...
public class MealExpandableListAdapter extends BaseExpandableListAdapter {
    ...
    public MealExpandableListAdapter(Context context, List<String> expandableListTitle,
    ...
    public View getChildView(int listPosition, final int expandedListPosition,
        ...
        final Meal expandedListText = (Meal) getChild(listPosition, expandedListPosition);
        if (convertView == null) {
