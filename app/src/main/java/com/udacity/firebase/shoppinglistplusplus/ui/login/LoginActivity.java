...
import com.udacity.firebase.shoppinglistplusplus.ui.ClientMainActivity;
import com.udacity.firebase.shoppinglistplusplus.ui.TrainerMainActivity;
    ...
    private class MyAuthResultHandler implements Firebase.AuthResultHandler {
        ...
        public void onAuthenticated(AuthData authData) {
            ...
            if (authData != null) {
                ...
                /* Save provider name and encodedEmail for later use and start TrainerMainActivity */
                mSharedPrefEditor.putString(Constants.KEY_PROVIDER, authData.getProvider()).apply();
                mSharedPrefEditor.putString(Constants.KEY_ENCODED_EMAIL, mEncodedEmail).apply();
